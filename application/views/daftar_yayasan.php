                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table no-margin">
                            <a href="<?php echo base_url("index.php/main/cetak"); ?>" class="btn btn-sm btn-default btn-flat pull-right">Cetak</a>
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama Yayasan</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $u->nm_penanggungjwb ?></td>
                                    <td><?php echo $u->nm_pemohon ?></td>
                                    <td><?php echo $u->alamat ?></td>
                                    <td><?php echo $u->no_telp ?></td>
                                    <td><?php echo $u->email ?></td>
                                    <td><span class="label label-success"><?php echo $u->status ?></span></td>
                                    <td><?php echo anchor('daftar_yayasan/edit/'.$u->id_yayasan,'Edit'); ?></td>
                                    <td><?php echo anchor('daftar_yayasan/hapus/'.$u->id_yayasan,'Hapus'); ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
