                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table no-margin">
                            <a href="<?php echo base_url()?>index.php/c_jasaprint/cetakpdf" class="btn btn-sm btn-default btn-flat pull-right">Cetak</a>
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama Lengkap</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $u->pend_akhir ?></td>
                                    <td><?php echo $u->email ?></td>
                                    <td><?php echo $u->status ?></td>
                                    
                                    <td><?php echo anchor('donasijasa_admin/edit/'.$u->id_donasi_jasa,'Edit'); ?></td>
                                    <td><?php echo anchor('donasijasa_admin/hapus/'.$u->id_donasi_jasa,'Hapus'); ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
