...
<div class="box-body">
    <div class="form-horizontal">
        <?php foreach($donasi_barang as $u){ ?>
        <form action="<?php echo base_url('index.php/donasibrg_admin/update'); ?>" method="post">
            <div class="form-group">
                <label class="control-label col-xs-3" >Nama Pengirim</label>
                <div class="col-xs-9">
                    <input type="hidden" name="id_donasi_barang" value="<?php echo $u->id_donasi_barang ?>">
                    <input type="text" name="nm_pengirim" value="<?php echo $u->nm_pengirim ?>" style="width:335px;">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-3" >Nama Barang</label>
                <div class="col-xs-9">
                    <input type="text" name="nm_brg" value="<?php echo $u->nm_brg ?>" style="width:335px;">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-3" >Jumlah Barang</label>
                <div class="col-xs-9">
                    <input type="text" name="jml_brg" value="<?php echo $u->jml_brg ?>" readonly style="width:335px;">
                </div>
            </div>
            <div class="form-group">
