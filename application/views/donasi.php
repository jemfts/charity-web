       ...
       <!--  <div class="navbar-header">
        ...
        <!-- <div class="container" style="margin-left: 78%; ">
          <ul class="nav navbar-nav navbar-right"> -->
           ...
           <!--  <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?php echo site_url('donation/tampil_cart')?>"><i style="color: #3E9EEE; font-size: 16px;" class="fa fa-shopping-cart"><strong> Keranjang Donasi</strong></a></li></i> 
          </ul> -->
        <!-- </div> --><!--/.nav-collapse -->
    <!-- </nav> -->
<!-- <br> -->
...
<div class="row">
        ...
        <div class="col-lg-3">
         ...
         <!--  <div class="list-group">
            <a class="list-group-item" style="color: #3E9EEE"><strong>KATEGORI</strong></a>
            <a href="<?php echo site_url('donation/index/')?>" class="list-group-item" style="color: black">Semua</a>
            <?php
            if(is_array($kategori)){
                foreach ($kategori as $row) 
            {
      ?>
            <a href="<?php echo base_url()?>index.php/donation/index/<?php echo $row['id'];?>" class="list-group-item" style="color: black"><?php echo $row['nama_kategori'];?></a>
            <?php
            }}
      ?>
          </div><br> -->
           ...
           <div class="list-group">
           <a href="<?php echo site_url('donation/tampil_cart')?>" class="list-group-item" style="background-color: #3E9EEE; color: white"><strong>KERANJANG DONASI</strong></a>
          <?php 
