                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table no-margin">
                            <a href="<?php echo base_url()?>index.php/c_brgprint/cetakpdf" class="btn btn-sm btn-default btn-flat pull-right">Cetak</a>
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama Pengirim</th>
                            ...
                            <tbody>
                                ...
                                foreach($donasi_barang as $u){ 
                                ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $u->nm_pengirim ?></td>
                                    <td><?php echo $u->nm_brg ?></td>
                                    <td><?php echo $u->jml_brg ?></td>
                                    <td><?php echo $u->no_telp ?></td>
                                    <td><?php echo $u->email ?></td>
                                    <td><?php echo $u->status ?></td>
                                    
                                    <td><?php echo anchor('donasibrg_admin/edit/'.$u->id_donasi_barang,'Edit'); ?></td>
                                    <td><?php echo anchor('donasibrg_admin/hapus/'.$u->id_donasi_barang,'Hapus'); ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
