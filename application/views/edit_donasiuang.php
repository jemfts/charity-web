...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Donasi Uang</li>
    </ol>
</section><br><br><br>
<div class="box-body">
    <div class="form-horizontal">
        <?php foreach($donasi_uang as $u){ ?>
        <form action="<?php echo base_url('index.php/donasiuang_admin/update'); ?>" method="post">
            <div class="form-group">
                <label class="control-label col-xs-3" >Nama Donatur</label>
                <div class="col-xs-9">
                    <input type="hidden" name="id_donasi_uang" value="<?php echo $u->id_donasi_uang ?>">
                    <input type="text" name="nm_donatur" value="<?php echo $u->nm_donatur ?>" style="width:335px;">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-xs-3" >Jumlah Uang</label>
                <div class="col-xs-9">
                    <input type="text" name="jml_uang" value="<?php echo $u->jml_uang ?>" readonly style="width:335px;">
                </div>
            </div>
            <div class="form-group">
