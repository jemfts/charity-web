...
<table class="table"  style="padding-right:1000px">
<tr id= "main_heading" style='background-color: white;'>
<td >No</td>
<td >Gambar</td>
<td >Yayasan</td>
<td ></td>
...
<td><input type="hidden" class="form-control input-sm" name="cart[<?php echo $item['id'];?>][qty]" value="<?php echo $item['qty'];?>"></td>
...
<tr>
<td colspan="5"><!-- <b>Total Donasi: Rp <?php echo number_format($grand_total, 0,",","."); ?></b> --></td>
<td colspan="3" align="right">
<a data-toggle="modal" data-target="#myModal"  class ='btn btn-sm btn-danger'>Kosongkan Donasi</a><br>
<!-- <button class='btn btn-sm btn-success'  type="submit">Update Donasi </button> -->
<!-- <a href="<?php echo site_url('donation/check_out')?>"  class ='btn btn-sm btn-primary'>Check Out</a> -->
</tr>
