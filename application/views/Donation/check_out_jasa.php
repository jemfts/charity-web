...
<div class="row">
  <div class="col-75" style="padding-left: 10px; padding-right: 150px">
    <div class="boxcontainer">
      <form action="<?php echo site_url('donation/proses_order_jasa') ?>" method="post">
      
        <div class="row">
          <div class="col-25" >
            <h3>Donasi Jasa Form</h3>
            <label class="control-label" for="nm_lengkap"><i class="fa fa-user"></i> Nama Lengkap</label>
            <input type="text" class="form-control" id="nm_lengkap" name="nm_lengkap" placeholder="Your Name" required=""  size="30">
            <span class="text-danger" ><?php echo form_error('nm_lengkap'); ?></span>

            <label class="control-label" for="usia"><i class="fa fa-user"></i> Usia</label>
            <input type="number" class="form-control" id="usia" name="usia" placeholder="Your Age" required=""  size="30">
            ...
            <label class="control-label" for="pend_akhir"><i class="fa fa-graduation-cap"></i> Pendidikan Terakhir</label>
            <input type="text" class="form-control" id="pend_akhir" name="pend_akhir" placeholder="Pendidikan Terakhir" required=""  size="30">
            <span class="text-danger" ><?php echo form_error('pend_akhir'); ?></span>
